...
# Overrides
PRODUCT_NAME := ravion_6qp
PRODUCT_DEVICE := ravion_6qp
...
PRODUCT_COPY_FILES += \
    ...
    device/ravion/common/wifi/p2p_supplicant_overlay.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/p2p_supplicant_overlay.conf \
    device/ravion/common/wifi/wpa_supplicant_overlay.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wpa_supplicant_overlay.conf \
...
PRODUCT_COPY_FILES += \
    device/ravion/common/tools/fastboot_imx_flashall.bat:fastboot_imx_flashall.bat \
    device/ravion/common/tools/fastboot_imx_flashall.sh:fastboot_imx_flashall.sh \
    device/ravion/common/tools/fsl-sdcard-partition.sh:fsl-sdcard-partition.sh \
    device/ravion/common/tools/uuu_imx_android_flash.bat:uuu_imx_android_flash.bat \
    device/ravion/common/tools/uuu_imx_android_flash.sh:uuu_imx_android_flash.sh
