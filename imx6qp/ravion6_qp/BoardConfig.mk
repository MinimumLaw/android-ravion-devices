...
# Support gpt
BOARD_BPT_INPUT_FILES += device/ravion/common/partition/device-partitions-7GB.bpt
ADDITION_BPT_PARTITION = partition-table-14GB:device/ravion/common/partition/device-partitions-14GB.bpt \
                         partition-table-28GB:device/ravion/common/partition/device-partitions-28GB.bpt
...
BOARD_SEPOLICY_DIRS := \
       device/ravion/imx6qp/sepolicy \
       $(IMX_DEVICE_PATH)/sepolicy

TARGET_BOARD_KERNEL_HEADERS := device/ravion/common/kernel-headers
