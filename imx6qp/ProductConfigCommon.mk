...
# Omx related libs, please align to device/ravion/proprietary/omx/fsl-omx.mk
PRODUCT_PACKAGES += \
...
PRODUCT_COPY_FILES +=	\
    ...
    device/ravion/common/input/Dell_Dell_USB_Entry_Keyboard.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/Dell_Dell_USB_Entry_Keyboard.idc \
    device/ravion/common/input/Dell_Dell_USB_Keyboard.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/Dell_Dell_USB_Keyboard.idc \
    device/ravion/common/input/Dell_Dell_USB_Keyboard.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/Dell_Dell_USB_Keyboard.kl \
    device/ravion/common/input/eGalax_Touch_Screen.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/HannStar_P1003_Touchscreen.idc \
    device/ravion/common/input/eGalax_Touch_Screen.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/Novatek_NT11003_Touch_Screen.idc \
    device/ravion/common/input/eGalax_Touch_Screen.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/eGalax_Touch_Screen.idc \
    device/ravion/imx6qp/etc/init.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.freescale.usb.rc \
    device/ravion/imx6qp/etc/ota.conf:$(TARGET_COPY_OUT_VENDOR)/etc/ota.conf \
    device/ravion/imx6qp/init.recovery.freescale.rc:root/init.recovery.freescale.rc \
...
PRODUCT_DEFAULT_DEV_CERTIFICATE := \
    device/ravion/common/security/testkey
