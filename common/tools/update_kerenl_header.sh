...
# cd android_dir & touch device/ravion/common/kernel-headers/linux/new_uapi &
...
imx_kernel_header_path="device/ravion/common/kernel-headers/linux/"
...
do
    cp ${bionic_kernel_header_path}/$file device/ravion/common/kernel-headers/linux/.
done
